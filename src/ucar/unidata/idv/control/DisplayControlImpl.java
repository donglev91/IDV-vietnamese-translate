...
public abstract class DisplayControlImpl extends DisplayControlBase implements DisplayControl,
    ...
    */
    ...
    protected List doMakeMenuBarMenus(List menus) {
        ...
        final JMenu fileMenu = new JMenu("Tệp");
        fileMenu.setMnemonic(GuiUtils.charToKeyCode("F"));
        final JMenu editMenu = new JMenu("Chỉnh Sửa");
        editMenu.setMnemonic(GuiUtils.charToKeyCode("E"));
        final JMenu viewMenu = new JMenu("Khung Nhìn");
        viewMenu.setMnemonic(GuiUtils.charToKeyCode("V"));
        final JMenu helpMenu = new JMenu("Trợ Giúp");
    ...
    private void makeFileMenu(JMenu menu) {
        ...
        items.add(GuiUtils.MENU_SEPARATOR);
        items.add(GuiUtils.makeMenu(new JMenu("Lưu"), saveItems));
    ...
    public List getControlMenus(final JComponent comp) {
        ...
        fileItems.add(GuiUtils.makeMenu(new JMenu("Lưu"), saveItems));
        ...
        JMenuItem mi;
        List      items = new ArrayList();
        items.add(GuiUtils.makeMenu("Tệp", fileItems));
        items.add(GuiUtils.makeMenu("Chỉnh Sửa", editItems));
        items.add(GuiUtils.makeMenu("Khung Nhìn", viewItems));
        if ( !extraMenus.isEmpty()) {
            for (int i = 0; i < extraMenus.size(); i++) {
                items.add(extraMenus.get(i));
            }
        }
        items.add(GuiUtils.makeMenu("Trợ Giúp", helpItems));
    ...
    public void setUsesTimeDriver(boolean value) {
        ...
        if(getDataSelection() != null){
            getDataSelection().putProperty(DataSelection.PROP_USESTIMEDRIVER, value);
        }
