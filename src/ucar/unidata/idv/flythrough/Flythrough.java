...
public class Flythrough extends SharableImpl implements PropertyChangeListener,
    ...
    private void makeWidgets() throws VisADException, RemoteException {
        ...
        tabbedPane.addTab("Bảng Điều Khiển", doMakeDashboardPanel());
    ...
    public JMenuBar doMakeMenuBar() {
        ...
        JMenu fileMenu = GuiUtils.makeDynamicMenu("Tệp", this,
                             "initFileMenu");
        JMenu editMenu = GuiUtils.makeDynamicMenu("Chỉnh Sửa", this,
                             "initEditMenu");
        JMenu viewMenu = GuiUtils.makeDynamicMenu("Khung Nhìn", this,
                             "initViewMenu");
    ...
    public void initViewMenu(JMenu viewMenu) {
        JMenu dashboardMenu = new JMenu("Bảng Điều Khiển");
