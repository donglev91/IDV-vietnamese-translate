...
public class IdvUIManager extends IdvManager {
    ...
    /**
     *  The identifier of the "Dữ Liệu" menu held in the xml file that defines
    ...
    /**
     *  The identifier of the "Lịch Sử" menu held in the xml file that defines
    ...
    /**
     *  The identifier of the "Hiển Thị" menu held in the xml file that defines
     *  the menu bar (e.g., resources/defaultmenu.xml). We use this identifier
     *  to find the actual JMenu that is created from the xml so we can dink with it.
     */
    ...
    public void getComponentGroupMenuItems(final IdvComponentGroup group,
        ...
        mapviewItems.add(GuiUtils.makeMenuItem("Khung Nhìn Bản Đồ", group, "makeNew",
        ...
        mapviewItems.add(GuiUtils.makeMenuItem("Transect View", group, "makeNew",
                                           ...
                                           newItems.add(GuiUtils.makeMenu("Khung Nhìn", mapviewItems));*/
        ...
        /*
        newItems.add(GuiUtils.makeMenuItem("Chọn Dữ Liệu", group, "makeNew",
                                           IdvUIManager.COMP_COMPONENT_CHOOSERS));

        newItems.add(GuiUtils.makeMenuItem("Chọn Lĩnh Vực", group, "makeNew",
        ...
        */
        ...
        items.add(GuiUtils.makeMenu("Tạo Mới", newItems));
    ...
    private void updateDataMenu(JMenu dataMenu) {
        ...
        for (int i = 0; i < dataSources.size(); i++) {
            ...
            JMenu editMenu = GuiUtils.makeMenu("Chỉnh Sửa",
    ...
    public JMenu doMakeDataChoiceMenu(DataChoice dataChoice) {
        return GuiUtils.makeMenu("Hiển Thị",
