...
public class StationModelCanvas extends EditCanvas {
    ...
    private void makeFileMenu() {
        fileMenu.removeAll();
        fileMenu.add(makeMenuItem("Tạo Mới", 'n', GuiUtils.CMD_NEW));
        fileMenu.addSeparator();
        fileMenu.add(makeMenuItem("Lưu", 's', GuiUtils.CMD_SAVE));
        fileMenu.add(makeMenuItem("Lưu...", GuiUtils.CMD_SAVEAS));
        fileMenu.add(makeMenuItem("Rename...", GuiUtils.CMD_RENAME));
        fileMenu.addSeparator();
        JMenuItem removeMenuItem = makeMenuItem("Xóa",
                                       GuiUtils.CMD_REMOVE);
    ...
    protected void doNew() {
        ...
        String newName = smm.doNew(this, "Tạo Mới", "model", "Provide a name for the model");
        if (newName == null) {
            return;
        }
