...
public class GuiUtils extends LayoutUtil {
    ...
    public static String CMD_REMOVE = "Xóa";

    /** Action command used for the New button */
    public static String CMD_NEW = "Tạo Mới";
    ...
    public static JPanel makeOkHelpCancelButtons(ActionListener l) {
        return makeButtons(l, new String[] { "OK", "Trợ Giúp", "Cancel" },
                           new String[] { CMD_OK,
                                          CMD_HELP, CMD_CANCEL });
    }
    ...
    public static JPanel makeApplyOkHelpCancelButtons(ActionListener l) {
        return makeButtons(l, new String[] { "Apply", "OK", "Trợ Giúp",
                                             "Cancel" }, new String[] {
                                             CMD_APPLY,
